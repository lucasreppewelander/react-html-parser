...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["reactHtmlParser"] = factory();
	else
		root["reactHtmlParser"] = factory();
})(window, function() {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(2)(module), __webpack_require__(3)))
...
/* harmony default export */ var type = (NodeType);

// CONCATENATED MODULE: ./node_modules/node-html-parser/dist/esm/nodes/comment.js


class comment_CommentNode extends Node {
    constructor(rawText) {
        super();
 ...
 */
class text_TextNode extends Node {
    constructor(rawText) {
        super();
        this.rawText = rawText;
        /**
 ...
 * @extends {Node}
 */
class html_HTMLElement extends Node {
    /**
     ...
     */
    get text() {
        return Object(he["decode"])(this.rawText);
    }
    /**
    ...
    set_content(content, options = {}) {
        if (content instanceof Node) {
            ...
            content = r.childNodes.length ? r.childNodes : [new text_TextNode(content)];
        }
    ...
    appendChild(node) {
        ...
        if (node instanceof html_HTMLElement) {
            node.parentNode = this;
        }
        return node;
    }
    ...
    get attributes() {
        ...
        for (const key in attrs) {
            const val = attrs[key] || '';
            this._attrs[key] = Object(he["decode"])(val);
        }
        return this._attrs;
    }
    /**
    ...
    setAttribute(key, value) {
        ...
        if (this._attrs) {
            this._attrs[key] = Object(he["decode"])(attrs[key]);
        }
        // Update rawString
        this.rawAttrs = Object.keys(attrs).map((name) => {
            const val = JSON.stringify(attrs[name]);
    ...
    insertAdjacentHTML(where, html) {
        ...
        if (where === 'afterend') {
            ...
            p.childNodes.forEach((n) => {
                if (n instanceof html_HTMLElement) {
    ...
    get nextElementSibling() {
        if (this.parentNode) {
            ...
            while (i < children.length) {
                const child = children[i++];
                if (find) {
                    if (child instanceof html_HTMLElement) {
                        return child || null;
                    }
                }
                else if (this === child) {
...
function base_parse(data, options = { lowerCaseTagName: false, comment: false }) {
    ...
    const root = new html_HTMLElement(null, {});
    ...
    while ((match = kMarkupPattern.exec(data))) {
        if (lastTextPos > -1) {
            if (lastTextPos + match[0].length < kMarkupPattern.lastIndex) {
                ...
                currentParent.appendChild(new text_TextNode(text));
            }
        }
        ...
        if (match[0][1] === '!') {
            ...
            if (options.comment) {
                ...
                currentParent.appendChild(new comment_CommentNode(text));
            }
            continue;
        }
        ...
        if (!match[1]) {
            ...
            // https://github.com/taoqf/node-html-parser/issues/38
            currentParent = currentParent.appendChild(new html_HTMLElement(match[2], attrs, match[3]));
...
var replaceWithComponent = function replaceWithComponent(node, index, tags) {
  var Component = tags(node.tagName.toLowerCase(), _extends({}, node.attributes, {
    key: index,
    children: src_htmlToReact(node.innerHTML, tags)
  }));
  return Component;
};

var src_htmlToReact = function htmlToReact(html, tags) {
...
/* harmony default export */ var src = __webpack_exports__["default"] = (src_htmlToReact);
